<template>
    <div class="sidebar" @mouseenter="isMenuOver=true" @mouseleave="isMenuOver=false" @touchstart="isMenuOver=true">
        <div class="main-menu">
            <vue-perfect-scrollbar class="scroll" :settings="{ suppressScrollX: true, wheelPropagation: false }">
                <ul class="list-unstyled">
                    <li :class="{ active : selectedParentMenu==='crazy' }">
                        <a @click.prevent="openSubMenu($event,'crazy')" href="#crazy">
                            <i class="iconsminds-shop-4"></i>{{ $t("menu.crazy") }}
                        </a>
                    </li>
                </ul>
                <ul class="list-unstyled">
                    <li :class="{ active : selectedParentMenu==='user' }">
                        <a @click.prevent="openSubMenu($event,'user')" href="#user">
                            <i class="iconsminds-shop-4"></i>{{ $t("menu.user") }}
                        </a>
                    </li>
                </ul>
                <ul class="list-unstyled">
                    <li :class="{ active : selectedParentMenu==='admin' }">
                        <a @click.prevent="openSubMenu($event,'admin')" href="#admin">
                            <i class="iconsminds-shop-4"></i>{{ $t("menu.admin") }}
                        </a>
                    </li>
                </ul>
                <ul class="list-unstyled">
                    <li :class="{ active : selectedParentMenu==='blog' }">
                        <a @click.prevent="openSubMenu($event,'blog')" href="#blog">
                            <i class="iconsminds-shop-4"></i>{{ $t("menu.blog") }}
                        </a>
                    </li>
                </ul>
        ...
        <div class="sub-menu">
            <vue-perfect-scrollbar class="scroll" :settings="{ suppressScrollX: true, wheelPropagation: false }">
                <ul class="list-unstyled" data-link="crazy"
                    :class="{'d-block':selectedParentMenu==='crazy' }">
